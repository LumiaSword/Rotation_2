...
combined_cov %>%
  group_by(transcript, region, experiment) %>%
  ...
  facet_wrap(~ experiment + region, scales = "free_x", nrow = 6, ncol = 3) # each row an experiment
...
top100_h1299_mod = setdiff(top100_h1299_modified,excluded_transcripts) # filter out the excluded outliers
